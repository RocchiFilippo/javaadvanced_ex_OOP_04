...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        try {
            ...
            String myNewString = Files.readString(MY_PATH) + "\nHello world!";

            Files.writeString(MY_PATH, myNewString);
    ...
    private static void exercise2() {
        ...
        try {
            // Your code here
            String ex2String = Files.readString(MY_PATH);
    ...
    private static void exercise3() {
        ...
        try {
            // Your code here
            String ex3String = Files.readString(MY_PATH);
            int linesNumber = 0;
            String[] splittedString = ex3String.split(" ");
    ...
    private static void exercise4() {
        ...
        try {
            // Your code here
            String ex4String = Files.readString(MY_PATH);
            String[] splittedString = ex4String.split(" ");
